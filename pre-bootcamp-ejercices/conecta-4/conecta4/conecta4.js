...
class Conecta4 {
    constructor(ButtonPlay, ButtonPlayVSComp, CirclesColumnOne, CirclesColumnTwo, CirclenColumnThree, CirclesColumnFour, CirclesColumnFive, CirclesColumnSix, CirclesColumnSeven, columnOne, columnTwo, columnThree, columnFour, columnFive, columnSix, columnSeven, h1title){
    ...
    ArrayGameChecker = (num, Positioncolumn)=> {
        const column = [this.GameCheck[num][0],this.GameCheck[num][1],this.GameCheck[num][2],this.GameCheck[num][3],this.GameCheck[num][4], this.GameCheck[num][5]];
        const row = [this.GameCheck[3][Positioncolumn], this.GameCheck[4][Positioncolumn], this.GameCheck[5][Positioncolumn],this.GameCheck[6][Positioncolumn], this.GameCheck[7][Positioncolumn], this.GameCheck[8][Positioncolumn], this.GameCheck[9][Positioncolumn]];
        const leftDownToRightUp = [this.GameCheck[num-3][Positioncolumn+3] ,this.GameCheck[num-2][Positioncolumn+2],this.GameCheck[num-1][Positioncolumn+1],this.GameCheck[num][Positioncolumn], this.GameCheck[num+1][Positioncolumn-1], this.GameCheck[num+2][Positioncolumn-2], this.GameCheck[num+3][Positioncolumn-3]];
        const leftUpToRightdown = [this.GameCheck[num-3][Positioncolumn-3], this.GameCheck[num-2][Positioncolumn-2],this.GameCheck[num-1][Positioncolumn-1],this.GameCheck[num][Positioncolumn], this.GameCheck[num+1][Positioncolumn+1], this.GameCheck[num+2][Positioncolumn+2], this.GameCheck[num+3][Positioncolumn+3]];
    ...
    ActionColums = (Positioncolumn, circlesColums, num) => {
        if(this.PlayerTurn === 1 && Positioncolumn >= 0){
            circlesColums[Positioncolumn].style.background = "linear-gradient(rgb(3, 58, 3), 30%, rgb(19, 117, 25))"
            ...
            circlesColums[Positioncolumn].style.background = "linear-gradient(rgb(58, 6, 3), 30%, rgb(152, 22, 20)"
    ...
    Play = () => {
        this.ButtonPlay.addEventListener('click', ()=> {
            ...
            this.CirclesColumnOne.forEach(element => {
                element.style.background = "linear-gradient(rgb(69, 69, 186), 30%, white)"
                 });
...
class Conecta4vsMachine {
    constructor(ButtonPlay, ButtonPlayVSComp, CirclesColumnOne, CirclesColumnTwo, CirclenColumnThree, CirclesColumnFour, CirclesColumnFive, CirclesColumnSix, CirclesColumnSeven, columnOne, columnTwo, columnThree, columnFour, columnFive, columnSix, columnSeven, h1title){
        ...
        this.columnSix = columnSix;
        this.columnSeven = columnSeven;
        this.columnsForRandom = [CirclesColumnOne,
            CirclesColumnTwo,
            CirclenColumnThree,
            CirclesColumnFour,
            CirclesColumnFive,
    ...
    ArrayGameChecker = (num, Positioncolumn, nc, npc)=> {
        ...
        this.GameCheckerDiagonals(leftDownToRightUp);
        this.GameCheckerDiagonals(leftUpToRightdown);
        if(this.GameCheckerColumsRows(column) == false && this.GameCheckerColumsRows(row) == false && this.GameCheckerDiagonals(leftDownToRightUp) == false && this.GameCheckerDiagonals(leftUpToRightdown) == false && this.PlayerTurn == 2){
    ...
    ComputerPlayer = (npc, nc , num) =>{
        ...
        } while(this.PositionColumn[RandomColumn] < 0 && this.PositionColumn.every(e => e == 0) == false)

        let Interval = setInterval(() => {
            this.columnsForRandom[RandomColumn][this.PositionColumn[RandomColumn]].style.background = "linear-gradient(rgb(58, 6, 3), 30%, rgb(152, 22, 20)";
            this.ColumsClick();
            this.GameCheck[RandomColumn + 3][this.PositionColumn[RandomColumn]] = 'red'
            this.PlayerTurn = 1;
            this.ArrayGameChecker(RandomColumn + 3, this.PositionColumn[RandomColumn]);
    ...
    VariablesForNewGame = () =>{
        this.PositionColumn.forEach((e, i)=> {this.PositionColumn[i] = 5});
        this.PositionColumnOne = 5;
        this.PositionColumnTwo = 5;
        this.PositionColumnThree = 5;
        this.PositionColumnFour = 5;
